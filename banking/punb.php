...
<head>
    ...
    <title> PUN  Bank  </title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
        <a class="navbar-brand active" href="punb.php">PUN<i class="fa fa-university" aria-hidden="true"></i></a>
    ...
    <div class="container mt-3  text-center">
        ...
        <br>
          <img src="bank5.png" alt="" height="300px" width="300px">
    </div>
    <div class="container text-center "><button type="button" class="btn btn-danger my-4">POORVA N. - Owner</button>
    </div>
    </div>
